...
namespace LccApiNet.LibraryGenerator.Core
{
    public class CategoriesMerger
    {
        public static bool MergeCategory(string outputPath, string libraryPath, LocalCategory category)
        {
            ...
            SyntaxTree oldAbstraction = null!;
            string? oldAbstractionContent = null!;
            ...
            SyntaxTree oldImplementation = null!;
            string? oldImplementationContent = null!;
            ...
            SyntaxTree newAbstraction = null!;
            string? newAbstractionContent = null!;
            ...
            SyntaxTree newImplementation = null!;
            string? newImplementationContent = null!;
            using (MemoryStream stream = new MemoryStream()) {
                StreamWriter writer = new StreamWriter(stream);
            ...
            foreach (var method in alreadyAbstractedMethods) {
