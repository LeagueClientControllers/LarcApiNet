...
namespace LccApiNet.LibraryGenerator.Core
{
    public class CoreClassModifier
    {
        ...
        public static string ModifyImplementation(string content, SyntaxTree syntax, List<LocalCategory> categories)
        {
            List<string> tabularContent = content.Split("\r\n").ToList();
        ...
        public static Range ExtractCategoriesSectionRange(SyntaxTree syntax, string className)
        {
