...
namespace LarcApiNet.Categories {
    ...
    public class DeviceCategory : IDeviceCategory {
        ...
        {
        	DevicesResponse response = await this._api.ExecuteAsync<DevicesResponse> ("/device/getDevices", true, token);
        ...
        public async Task<Device> GetDeviceByIdAsync(int id, CancellationToken token = default) 
        {
        	...
        	DeviceResponse response = await this._api.ExecuteAsync<DeviceResponse, GetByIdParameters> ("/device/getDeviceById", parameters, true, token);
        	// <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved.
        	// TODO: Add response validation
        	// </auto-generated-safe-area>
        ...
        {
        	ControllersResponse response = await this._api.ExecuteAsync<ControllersResponse> ("/device/getControllers", true, token);
        	// <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved.
        	// TODO: Add response validation
        	// </auto-generated-safe-area>
        ...
        /// <inheritdoc />
        public async Task GetControllerByIdAsync(int id, CancellationToken token = default) 
        {
        	// <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved.
        	// TODO: Add parameters validation
        	// </auto-generated-safe-area>
        	GetByIdParameters parameters = new GetByIdParameters (id);
        	await this._api.ExecuteAsync<GetByIdParameters> ("/device/getControllerById", parameters, true, token);
        }
