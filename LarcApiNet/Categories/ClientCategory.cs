...
namespace LarcApiNet.Categories {
    ...
    public class ClientCategory : IClientCategory {
        ...
        public async Task ReportChampSelectStartedAsync(int userPosition, QueueType queueType, bool bansPlanned, int enemiesCount, List<Role> alliesRoles, List<int> availableChampions, CancellationToken token = default) 
        {
        	...
        	ChampSelectParameters parameters = new ChampSelectParameters (userPosition, queueType, bansPlanned, enemiesCount, alliesRoles, availableChampions);
        ...
        /// <inheritdoc />
        public async Task ReportActionCompletedAsync(int actorPosition, bool isActorAnAlly, int? championId, CancellationToken token = default) 
        {
        	// <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved.
        	// TODO: Add parameters validation
        	// </auto-generated-safe-area>
        	ActionCompletedParameters parameters = new ActionCompletedParameters (actorPosition, isActorAnAlly, championId);
        	await _api.ExecuteAsync<ActionCompletedParameters> ("/client/reportActionCompleted", parameters, true, token);
        }
        
        /// <inheritdoc />
        public async Task ReportChampionHoveredAsync(int actorPosition, bool isActorAnAlly, int championId, CancellationToken token = default) 
        {
        	// <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved.
        	// TODO: Add parameters validation
        	// </auto-generated-safe-area>
        	ChampionHoveredParameters parameters = new ChampionHoveredParameters (actorPosition, isActorAnAlly, championId);
        	await _api.ExecuteAsync<ChampionHoveredParameters> ("/client/reportChampionHovered", parameters, true, token);
        }
        
        /// <inheritdoc />
        public async Task ReportSkinChangedAsync(int summonerPosition, int skinId, CancellationToken token = default) 
        {
        	// <auto-generated-safe-area> Code within tag borders shouldn't cause incorrect behavior and will be preserved.
        	// TODO: Add parameters validation
        	// </auto-generated-safe-area>
        	SkinChangedParameters parameters = new SkinChangedParameters (summonerPosition, skinId);
