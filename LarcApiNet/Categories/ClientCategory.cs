...
namespace LarcApiNet.Categories {
    ...
    public class ClientCategory : IClientCategory {
        ...
        public async Task ReportChampSelectStartedAsync(int userPosition, bool bansPlanned, int enemiesCount, List<Role> alliesRoles, List<int> availableChampions, CancellationToken token = default) 
        {
